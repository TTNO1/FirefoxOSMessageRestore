...
For the Nokia 2780, follow the steps in the readme [here](https://git.abscue.de/affe_null/weeknd-toolbox/). You will need a Linux system for this. Note that for the "building" step, you will need to install the following dependencies.
```
git
flex
bison
