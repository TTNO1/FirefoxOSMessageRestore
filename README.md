...
For the Nokia 2780, follow the steps in the readme [here](https://git.abscue.de/affe_null/weeknd-toolbox/). <mark>**Do not disable encryption (keep reading).**</mark> You will need a Linux system for this. Note that for the "building" step, you will need to install the following dependencies.
```
git
flex
bison
...
```
All of which can be easily installed with `apt install`. Proceed to the "Booting" step and stop before the "Sideloading guide" step. **IMPORTANT: Contrary to what the readme says, you do not need to disable encryption. Doing so will wipe all of your data needlessly.**
